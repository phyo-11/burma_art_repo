...
class ShippingForm(forms.ModelForm):
	...
	class Meta:
		...
		fields = ['shipping_full_name','shipping_phone','shipping_email','shipping_address1','shipping_address2','shipping_zipcode','shipping_city','shipping_state','shipping_country']
		exclude = ['user',]
...
class PaymentForm(forms.Form):
	...
	card_address1 = forms.CharField(label='', widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Address1'}), required=True)
	card_address2 = forms.CharField(label='', widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Address2'}), required=False)
